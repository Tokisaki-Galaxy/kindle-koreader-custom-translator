--[[--
This module translates text using Custom Translate.
--]]
...
function Translator:loadPage(text, target_lang, source_lang)
    ...
    if source_lang and source_lang ~= "" and source_lang ~= AUTODETECT_LANGUAGE then
    ...
    local detected = result.sourceLanguage or source_lang or AUTODETECT_LANGUAGE

    -- Conform to the structure expected by downstream code:
    -- result[1] = { { translated_text, original_text } }
